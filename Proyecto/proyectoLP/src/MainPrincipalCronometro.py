...
from numero import *
from ventanaSudoku1 import Ui_prueba
...
class Main(QtGui.QMainWindow):
    ...
    def __init__(self):
        ...
        self.nuevoTiempo = QtCore.QTime()
        self.startTime()
        self.initGui()
        #self.timer = QtCore.QTimer(self)
        #self.timer.timeout.connect(self.showlcd)
        ###connect(timer,self.SIGNAL(timer.timeout()),self,QtCore.SLOT(self.startTime()))
    ...
    def startTime(self):      
        ...
        self.connect(self.timer,QtCore.SIGNAL("timeout()"),self.showlcd)
        self.segundos = 0
        self.minutos =0
        self.text = self.tiempo.toString("hh:mm:ss")
        self.ui.lcdNumber.display(self.text)
        self.timer.start(1000) 
    ...
    def showlcd(self):
        ...
        self.ui.lcdNumber.display(self.cronometro)     
